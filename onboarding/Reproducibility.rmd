...
You can click [here](https://github.com/ropensci-archive/reproducibility-guide/blob/gh-pages/sections/references/index.md) for some readings on reproducible results. 
